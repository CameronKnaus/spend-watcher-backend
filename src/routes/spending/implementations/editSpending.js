...
module.exports = function(request, response) {
    ...
    const { transactionId, category, amount, isUncommon, selectedDate, note} = request.body;
    ...
    let STATEMENT = `UPDATE spend_transactions SET category=${db.escape(category)}, amount=${db.escape(amount)},`
